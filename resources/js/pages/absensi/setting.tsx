...
export default function AbsensiSetting({ setting }: Props) {
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        put('/absensi/setting', {
            ...
            onError: () => {
                toast.error(
                    'Gagal memperbarui pengaturan. Periksa kembali inputan Anda.',
                );
            },
        });
    };
    ...
    return (
        <>
            ...
            <div className="mx-auto flex h-full max-w-4xl flex-1 flex-col gap-8 p-6">
                {/* Header Page */}
                <div className="flex flex-col gap-1.5 border-b pb-4">
                    ...
                    <p className="text-sm text-muted-foreground">
                        Kelola aturan jam masuk, jam pulang, toleransi
                        keterlambatan, dan status operasional sistem.
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            <div className="space-y-1.5 pr-4">
                                <CardTitle className="flex items-center gap-2.5">
                                    ...
                                    <span className="relative ml-2 flex h-3 w-3">
                                        ...
                                        <span
                                            className={`relative inline-flex h-3 w-3 rounded-full ${data.is_active ? 'bg-green-500' : 'bg-rose-500'}`}
                                        ></span>
                                    </span>
                                </CardTitle>
                                <CardDescription>
                                    Buka atau tutup akses sistem absensi RFID.
                                    Jika dimatikan, semua tap kartu akan ditolak
                                    secara otomatis.
                                </CardDescription>
                            </div>
                            ...
                            <button
                                ...
                                className={`${
                                    data.is_active
                                        ? 'bg-green-500'
                                        : 'bg-rose-500'
                                } relative inline-flex h-7 w-14 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:outline-none`}
                            >
                                <span
                                    aria-hidden="true"
                                    className={`${
                    ...
                    <Card className="overflow-hidden border-sidebar-border/70 shadow-sm dark:border-sidebar-border">
                        <CardHeader className="border-b bg-muted/20 pb-4">
                            ...
                            <CardDescription>
                                Tentukan batas waktu operasional pemindaian
                                kartu di pagi hari.
                            </CardDescription>
                        </CardHeader>
                            ...
                            <div className="grid gap-6 sm:grid-cols-3">
                                <div className="space-y-2.5">
                                    ...
                                    <p className="text-[12px] leading-tight text-muted-foreground">
                                        Waktu paling awal mesin menerima tap
                                        masuk.
                                    </p>
                                ...
                                <div className="space-y-2.5">
                                    <Label htmlFor="jam_masuk_batas">
                                        Batas Normal (Terlambat)
                                    </Label>
                                    <Input
                                        id="jam_masuk_batas"
                                        type="time"
                                    ...
                                    />
                                    <p className="text-[12px] leading-tight text-muted-foreground">
                                        Tap setelah jam ini akan dicatat sebagai
                                        Terlambat.
                                    </p>
                                ...
                                <div className="space-y-2.5">
                                    <Label htmlFor="jam_masuk_selesai">
                                        Jam Tutup Absen
                                    </Label>
                                    <Input
                                    ...
                                    />
                                    <p className="text-[12px] leading-tight text-muted-foreground">
                                        Waktu paling akhir tap masuk diizinkan
                                        mesin.
                                    </p>
                    ...
                    <Card className="overflow-hidden border-sidebar-border/70 shadow-sm dark:border-sidebar-border">
                        ...
                        <CardContent className="p-6">
                            <div className="grid gap-6 sm:grid-cols-2">
                                <div className="space-y-2.5">
                                    <Label htmlFor="jam_pulang_mulai">
                                        Jam Mulai Pulang
                                    </Label>
                                    <Input
                                        id="jam_pulang_mulai"
                                ...
                                <div className="space-y-2.5">
                                    <Label htmlFor="jam_pulang_selesai">
                                        Jam Tutup Mesin
                                    </Label>
                                    <Input
                                    ...
                                    />
                                    <p className="text-[12px] leading-tight text-muted-foreground">
                                        Waktu paling akhir tap pulang diizinkan
                                        mesin.
                                    </p>
